...
def TaskExe():
    ...
    def Music():
        ...
        if 'kitna' in musicName:
            os.startfile('F:\tuhje kitna chahe aur hum')

        elif 'ban' in musicName:
            os.startfile('F:\tera ban jaunga')

        else:
            pywhatkit.playonyt(musicName)

        Speak("Your Song Has Been Started! , mam!")

    def OpenApps():
        Speak("Ok mam , Wait A Second!")
        
        if 'code' in query:
            os.startfile("C:\\Users\\DELL\AppData\\Local\\Programs\\Microsoft VS Code.exe")

        elif 'telegram' in query:
            os.startfile("C:\\Users\\DELL\\AppData\\Roaming\\Telegram Desktop\\Telegram.exe")
    ...
    def Reader():
        ...
        if 'machine learning' in name:
            ...
            os.startfile('F:\machine learning')
            book = open('F:\machine learning','rb')
    ...
    def screenshot():
        Speak("Ok mam , What Should I Name That File ?")
        path = takecommand()
        path1name = path + ".png"
